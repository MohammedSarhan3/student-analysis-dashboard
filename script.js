    ...
    let html = `
        <div class="summary">
            ...
            <div class="summary-stats">
                ...
                <div class="summary-stat" style="background: rgba(46, 204, 113, 0.15);">
                    <div class="summary-stat-value" style="color: #27ae60;">${gradeData.totalPresent || 0}</div>
                    <div class="summary-stat-label">الحضور</div>
                </div>
                <div class="summary-stat" style="background: rgba(231, 76, 60, 0.15);">
                    <div class="summary-stat-value" style="color: #e74c3c;">${gradeData.totalAbsent || 0}</div>
                    <div class="summary-stat-label">الغياب</div>
                </div>
                <div class="summary-stat">
    ...
    grades.forEach(gradeKey => {
        ...
        html += `
            <tr onclick="switchTab('${gradeKey}')" style="cursor: pointer;">
                ...
                <td><span class="badge badge-success">${gradeData.totalPresent || 0}</span></td>
                <td><span class="badge badge-danger">${gradeData.totalAbsent || 0}</span></td>
